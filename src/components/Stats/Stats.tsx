        ...
        <div className="row justify-content-center">
          ...
          <div className="col-md-7 col-lg-6">
            <div className="number-content">
              ...
              <p>
                We blend creativity, expertise, and dedication to provide
                comprehensive solutions for architecture design, building
                construction, renovation, and maintenance. Lets build something
